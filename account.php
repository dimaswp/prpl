...
<body>
	...
	<section class="search">
		...
		<div id="fom">
			<form method="post">
			<h3 style="text-align:center; color: #000099; font-weight:bold; text-decoration:underline"><br>Customer Login</h3>
				<table height="100" align="center">
					...
					<tr>
						...
						<td style="text-align:right;">Belum punya akun ? <a href="signup.php">Daftar disini</a></td>
					</tr>
				</table>
			</form>
			<?php
